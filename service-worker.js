const CACHE_NAME = "mf-science-v6900-scheduling-warnings";
const APP_SHELL = [
  ...
  if(request.mode==="navigate"){
    event.respondWith((async()=>{
      try{
        ...
        if(url.pathname==="/teacher-login.html"){
          const teacherPage=await caches.match("/teacher-login.html",{ignoreSearch:true});
          if(teacherPage)return teacherPage;
        }
