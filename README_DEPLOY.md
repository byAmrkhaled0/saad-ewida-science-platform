...
الإصدار 69.2.4 يصلح مزامنة وقت الامتحان بعد النشر وماسح QR والكاميرا، ويضيف متابعة الواجب بالتفصيل وإشعارات الطلاب وسجل نسخ الامتحان وصفحة صحة المنصة. كما يستبدل مكتبات Firebase الخارجية بنسخ محلية ثابتة لتقليل أخطاء التحميل الجزئي.
