...
الإصدار 69.2.0 يحسن صفحات الحجوزات وتحذيرات الغياب وطلبات الطلاب على الهاتف، ويقرأ الصفوف والمجموعات من مواعيد Firebase ويستكمل بيانات الطلاب والطلبات القديمة من `scheduleId`. كما يصلح احتفاظ لوحة المدرس بطلبات النقل القادمة من Firestore، ويحافظ على جدولة الواجبات الآمنة وربط الطلاب والمحتوى بمعرّف المجموعة الدقيق، ويستخدم مسار `platformApi` لاسترداد CORS واختباره تلقائيًا أثناء `npm run deploy:production`.
