...
الإصدار 69.2.7 يضيف ضمان استهداف المحتوى للصف والمجموعة، إصلاح بيانات بوابة الطالب القديمة، توقيت القاهرة الموحد، والمراجعات وبنك الأسئلة داخل البوابة. يجب نشر Functions والواجهة معًا؛ نشر Vercel وحده لا يفعّل الإصلاحات الخلفية.
